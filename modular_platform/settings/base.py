"""
Django settings for modular_platform project.
...
ROOT_URLCONF = "modular_platform.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [PROJECT_ROOT / "templates"],  # cuma pointing ke templates global
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "modular_platform.wsgi.application"
